...
- Added support for using docker-credential-ecr-login for docker login, assuming the appropriate credential mode is set in `~/.docker/config.json` and AWS is configured in `~/.aws`
